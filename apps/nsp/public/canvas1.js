...
for(i = 0; i <= placesXzona/2; i++){
  llistaPlaces1["NW"+(i+1).toString()+'-P0'] = {x:_x, y:_y};
  _x = _x + amplePlasa
}
_x = 0
for(i = placesXzona/2; i < placesXzona; i++){
  llistaPlaces1["NW"+(i+1).toString()+'-P0'] = {x:_x, y: 100};
  _x = _x + amplePlasa
}
_x = 0
for(i = 0; i <= placesXzona/2; i++){
  llistaPlaces1["SW"+(i+1).toString()+'-P0'] = {x:_x, y: 300};
  _x = _x + amplePlasa
}
_x = 0
for(i = placesXzona/2; i < placesXzona; i++){
  llistaPlaces1["SW"+(i+1).toString()+'-P0'] = {x:_x, y: 400};
  _x = _x + amplePlasa
}
...
for(i = 0; i <= placesXzona/2; i++){
  llistaPlaces1["NE"+(i+1).toString()+'-P0'] = {x:_x2, y:_y};
  _x2 = _x2 + amplePlasa
}
_x2 = 560
for(i = placesXzona/2; i < placesXzona; i++){
  llistaPlaces1["NE"+(i+1).toString()+'-P0'] = {x:_x2, y: 100};
  _x2 = _x2 + amplePlasa
}
...
for(i = 0; i <= placesXzona/2; i++){
  llistaPlaces1["SE"+(i+1).toString()+'-P0'] = {x:_x2, y: 300};
  _x2 = _x2 + amplePlasa
}
_x2 = 560
for(i = placesXzona/2; i < placesXzona; i++){
  llistaPlaces1["SE"+(i+1).toString()+'-P0'] = {x:_x2, y: 400};
  _x2 = _x2 + amplePlasa
}

llistaPlaces1['placesXplanta'] = vehiclesXplanta




console.log("PEPE", llistaPlaces1)

llista_places1 = JSON.stringify(llistaPlaces1)
httpGet('http://'+ip+':8000/inserta_places', llista_places1)
...
function pintaplasa() {
  ...
  for(i = 560; i <= 1000; i = i + ampleNou*factorX){
    ...
    for(i = 1; i < vehiclesXplanta; i++){
      console.log('oscar',llistaPlaces1['NE2'])
      nomPlasa = humy[i]['plasa']
      console.log(nomPlasa)
      if(humy[i]['computa']){
        if(humy[i]['computa'] == true){
        ctx.fillRect(llistaPlaces1[nomPlasa]["x"], llistaPlaces1[nomPlasa]["y"], amplePlasa-2, 99);
        }
      }
    }
  }).catch(e => {
...
function pintaocupades() {
  ...
  for(i = 560; i <= 1000; i = i + ampleNou*factorX){
    ...
    for(i = 1; i <= vehiclesXplanta; i++){
      ...
      console.log(nomPlasa)
      ctx.fillRect(llistaPlaces1[nomPlasa]["x"], llistaPlaces1[nomPlasa]["y"], amplePlasa-1, 99);
      /*if(humy[i]['computa']){
        if(humy[i]['computa'] == true){
        ctx.fillRect(llistaPlaces1[nomPlasa]["x"], llistaPlaces1[nomPlasa]["y"], amplePlasa-1, 99);
        }
